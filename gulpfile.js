...
function watch() {
    browserSync.init({
        server: {
            baseDir: './',
            index: "/ampleadmin-html/ampleadmin-sidebar/index.html",
            directory: true
        },
        startPath: '/ampleadmin-html/ampleadmin-sidebar/index.html'
    })
    gulp.watch(['scss/**/*.scss'], style);
    gulp.watch(['dist/css/style.css'], minifycss);
    gulp.watch('ampleadmin-html/*.html').on('change', browserSync.reload);
